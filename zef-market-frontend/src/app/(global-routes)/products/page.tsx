...
const ProductsPage = () => {
  ...
  // Debounced keyword so we don't spam the API on each keystroke
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [brand, rating, sortByPrice, debouncedKeyword]);
  ...
  return (
    <Container sx={{ mt: 4, mb: 6, pt: 0.25 }}>
      {/* Filters Card */}
      <Paper
        elevation={0}
        sx={{
