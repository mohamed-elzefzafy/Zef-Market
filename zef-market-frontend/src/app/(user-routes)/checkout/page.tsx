...
//     method: "cash" | "card" | "paypal" | "paymob"
//   ) => {
//     try {
//       const order = await createOrder({ paymentMethodType: method }).unwrap();
...
//         // ✅ الدفع Paymob -> افتح الـ iframe URL
//         const { iframeUrl } = order;
//         if (iframeUrl) {
//           window.location.href = iframeUrl;
//         } else {
//           console.error("Paymob iframe URL not found");
//         }
//       }
//     } catch (err) {
//       console.error("createOrder error", err);
...
//         <Button
//           variant="contained"
//           sx={{ backgroundColor: "#ff5722" }} // لون Paymob (برتقالي/أحمر)
//           onClick={() => handleCheckout("paymob")}
//           disabled={isLoading}
//         >
//           Pay with Paymob
